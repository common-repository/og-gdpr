...
class OG_GDPR_AdminPageFramework_AdminNotice___Script extends OG_GDPR_AdminPageFramework_Factory___Script_Base {
...
( function( $ ) {
    jQuery( document ).ready( function() {         
        ...
        var _oAdminNotices = jQuery( '.og-gdpr-settings-notice-message' );
        if ( _oAdminNotices.length ) {
            ...
            var _oContainer     = jQuery( _oAdminNotices )
                ...
                .wrap( "<div class='og-gdpr-admin-notice-animation-container'></div>" );
