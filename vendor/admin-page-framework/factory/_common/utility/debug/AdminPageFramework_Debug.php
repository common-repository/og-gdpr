...
class OG_GDPR_AdminPageFramework_Debug_Base extends OG_GDPR_AdminPageFramework_FrameworkUtility {
    ...
    class OG_GDPR_AdminPageFramework_Debug_Log extends OG_GDPR_AdminPageFramework_Debug_Base {
    ...
    class OG_GDPR_AdminPageFramework_Debug extends OG_GDPR_AdminPageFramework_Debug_Log {
        ...
        static public function dumpArray($asArray, $sFilePath = null) {
            self::showDeprecationNotice('OG_GDPR_AdminPageFramework_Debug::' . __FUNCTION__, 'OG_GDPR_AdminPageFramework_Debug::dump()');
            OG_GDPR_AdminPageFramework_Debug::dump($asArray, $sFilePath);
        }
        static public function getArray($asArray, $sFilePath = null, $bEscape = true) {
            self::showDeprecationNotice('OG_GDPR_AdminPageFramework_Debug::' . __FUNCTION__, 'OG_GDPR_AdminPageFramework_Debug::get()');
            return OG_GDPR_AdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
        }
        static public function logArray($asArray, $sFilePath = null) {
            self::showDeprecationNotice('OG_GDPR_AdminPageFramework_Debug::' . __FUNCTION__, 'OG_GDPR_AdminPageFramework_Debug::log()');
            OG_GDPR_AdminPageFramework_Debug::log($asArray, $sFilePath);
        }
        static public function getAsString($mValue) {
            self::showDeprecationNotice('OG_GDPR_AdminPageFramework_Debug::' . __FUNCTION__);
