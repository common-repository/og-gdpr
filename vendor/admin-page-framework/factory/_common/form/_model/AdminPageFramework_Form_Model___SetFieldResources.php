...
class OG_GDPR_AdminPageFramework_Form_Model___SetFieldResources extends OG_GDPR_AdminPageFramework_Form_Base {
    ...
    private function ___setCommon() {
        ...
        new OG_GDPR_AdminPageFramework_Form_View___Script_RegisterCallback;
        $this->___setCommonFormInternalCSSRules();
    }
    private function ___setCommonFormInternalCSSRules() {
        $_aClassNames = array('OG_GDPR_AdminPageFramework_Form_View___CSS_Form', 'OG_GDPR_AdminPageFramework_Form_View___CSS_Field', 'OG_GDPR_AdminPageFramework_Form_View___CSS_Section', 'OG_GDPR_AdminPageFramework_Form_View___CSS_CollapsibleSection', 'OG_GDPR_AdminPageFramework_Form_View___CSS_FieldError', 'OG_GDPR_AdminPageFramework_Form_View___CSS_ToolTip',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
            $this->aResources['internal_styles'][] = $_oCSS->get();
        }
        $_aClassNamesForIE = array('OG_GDPR_AdminPageFramework_Form_View___CSS_CollapsibleSectionIE',);
    ...
    private function ___setFieldResourcesByFieldTypeDefinition($aFieldset, $_sFieldtype, $_aFieldTypeDefinition) {
        ...
        new OG_GDPR_AdminPageFramework_Form_Model___FieldTypeRegistration($_aFieldTypeDefinition, $this->aArguments['structure_type']);
        $_oFieldTypeResources = new OG_GDPR_AdminPageFramework_Form_Model___FieldTypeResource($_aFieldTypeDefinition, $this->aResources);
