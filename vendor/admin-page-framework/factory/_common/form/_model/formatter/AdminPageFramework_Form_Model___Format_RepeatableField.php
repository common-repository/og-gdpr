...
class OG_GDPR_AdminPageFramework_Form_Model___Format_RepeatableSection extends OG_GDPR_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct() {
        ...
        $this->_oMsg = $_aParameters[1] ? $_aParameters[1] : OG_GDPR_AdminPageFramework_Message::getInstance();
    }
    public function get() {
    ...
    class OG_GDPR_AdminPageFramework_Form_Model___Format_RepeatableField extends OG_GDPR_AdminPageFramework_Form_Model___Format_RepeatableSection {
        protected function _getDefaultMessage() {
