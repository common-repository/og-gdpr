...
class OG_GDPR_AdminPageFramework_FieldType_import extends OG_GDPR_AdminPageFramework_FieldType_submit {
...
jQuery( document ).ready( function() {
    jQuery( '.og-gdpr-field-import input[type=submit]' ).click( function( event ) {
        var _iFiles = jQuery( this ).closest( '.og-gdpr-field-import' ).find( 'input[type=file]' ).get( 0 ).files.length;
        if ( 0 === _iFiles ) {
...
JAVASCRIPT;
    ...
    protected function getStyles() {
        return ".og-gdpr-field-import input {margin-right: 0.5em;}.og-gdpr-field-import,.og-gdpr-field-import .og-gdpr-input-label-container {width: 100%;}.og-gdpr-field-import label,.form-table td fieldset.og-gdpr-fieldset .og-gdpr-field-import label { display: inline-block; width: auto;vertical-align: middle;}";
    }
