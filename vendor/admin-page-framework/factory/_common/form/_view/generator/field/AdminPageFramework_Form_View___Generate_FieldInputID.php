...
class OG_GDPR_AdminPageFramework_Form_View___Generate_FieldTagID extends OG_GDPR_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
    ...
    class OG_GDPR_AdminPageFramework_Form_View___Generate_FieldInputID extends OG_GDPR_AdminPageFramework_Form_View___Generate_FieldTagID {
        public $isIndex = '';
