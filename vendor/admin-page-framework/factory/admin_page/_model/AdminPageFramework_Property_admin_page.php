...
class OG_GDPR_AdminPageFramework_Property_admin_page extends OG_GDPR_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'og-gdpr') {
        ...
        $GLOBALS['aOG_GDPR_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aOG_GDPR_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['aOG_GDPR_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
