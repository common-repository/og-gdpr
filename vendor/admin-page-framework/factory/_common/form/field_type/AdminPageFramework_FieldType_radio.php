...
class OG_GDPR_AdminPageFramework_FieldType_radio extends OG_GDPR_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return ".og-gdpr-field input[type='radio'] {margin-right: 0.5em;} .og-gdpr-field-radio .og-gdpr-input-label-container {padding-right: 1em;} .og-gdpr-field-radio .og-gdpr-input-container {display: inline;} .og-gdpr-field-radio .og-gdpr-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.og-gdpr-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).prop( 'checked', false );
