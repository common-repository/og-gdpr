...
class OG_GDPR_AdminPageFramework_PageLoadInfo_admin_page extends OG_GDPR_AdminPageFramework_PageLoadInfo_Base {
    ...
    public static function instantiate($oProp, $oMsg) {
        ...
        self::$_oInstance = new OG_GDPR_AdminPageFramework_PageLoadInfo_admin_page($oProp, $oMsg);
        return self::$_oInstance;
    }
