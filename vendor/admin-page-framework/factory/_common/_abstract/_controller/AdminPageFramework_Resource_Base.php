...
abstract class OG_GDPR_AdminPageFramework_Resource_Base extends OG_GDPR_AdminPageFramework_FrameworkUtility {
    ...
    protected $_sClassSelector_Style = 'og-gdpr-style';
    protected $_sClassSelector_Script = 'og-gdpr-script';
    ...
    private function ___getCommonStyleTag($oCaller, $sIDPrefix) {
        $_sStyle = $this->addAndApplyFilters($oCaller, array("style_common_admin_page_framework", "style_common_{$this->oProp->sClassName}",), OG_GDPR_AdminPageFramework_CSS::getDefaultCSS());
    ...
    private function ___getCommonIEStyleTag($oCaller, $sIDPrefix) {
        $_sStyleIE = $this->addAndApplyFilters($oCaller, array("style_ie_common_admin_page_framework", "style_ie_common_{$this->oProp->sClassName}",), OG_GDPR_AdminPageFramework_CSS::getDefaultCSSIE());
    ...
    protected function _printCommonScripts($sIDPrefix, $sClassName) {
        ...
        $_sScript = $this->addAndApplyFilters($this->oProp->oCaller, array("script_common_admin_page_framework", "script_common_{$this->oProp->sClassName}",), OG_GDPR_AdminPageFramework_Property_Base::$_sDefaultScript);
    ...
    public function _replyToAddStyle() {
        ...
        $this->_printCommonStyles('og-gdpr-style-common', get_class());
    ...
    public function _replyToAddScript() {
        ...
        $this->_printCommonScripts('og-gdpr-script-common', get_class());
