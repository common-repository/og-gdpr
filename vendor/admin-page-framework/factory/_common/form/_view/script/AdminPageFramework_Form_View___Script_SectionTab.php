...
class OG_GDPR_AdminPageFramework_Form_View___Script_SectionTab extends OG_GDPR_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.og-gdpr-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='og-gdpr-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
    }
