...
/**
 ...
 Generated on 2021-05-25 */
if (!class_exists('OG_GDPR_AdminPageFramework_Registry', false)):
    abstract class OG_GDPR_AdminPageFramework_Registry_Base {
    ...
    final class OG_GDPR_AdminPageFramework_Registry extends OG_GDPR_AdminPageFramework_Registry_Base {
        ...
        static public function setUp($sFilePath = __FILE__) {
            ...
            self::$sAutoLoaderPath = isset(self::$aClassFiles['OG_GDPR_AdminPageFramework_RegisterClasses']) ? self::$aClassFiles['OG_GDPR_AdminPageFramework_RegisterClasses'] : '';
            self::$bIsMinifiedVersion = class_exists('OG_GDPR_AdminPageFramework_MinifiedVersionHeader', false);
            self::$bIsDevelopmentVersion = isset(self::$aClassFiles['OG_GDPR_AdminPageFramework_InclusionClassFilesHeader']);
        }
    ...
    if (!class_exists('OG_GDPR_AdminPageFramework_Bootstrap', false)):
        final class OG_GDPR_AdminPageFramework_Bootstrap {
            static private $_bLoaded = false;
            public function __construct($sLibraryPath) {
                if (!$this->_isLoadable()) {
                    return;
                }
                OG_GDPR_AdminPageFramework_Registry::setUp($sLibraryPath);
                if (OG_GDPR_AdminPageFramework_Registry::$bIsMinifiedVersion) {
                    return;
                }
                $this->_include();
            }
            ...
            private function _include() {
                include (OG_GDPR_AdminPageFramework_Registry::$sAutoLoaderPath);
                new OG_GDPR_AdminPageFramework_RegisterClasses('', array('exclude_class_names' => array('OG_GDPR_AdminPageFramework_MinifiedVersionHeader', 'OG_GDPR_AdminPageFramework_BeautifiedVersionHeader',),), OG_GDPR_AdminPageFramework_Registry::$aClassFiles);
                self::$_bXDebug = isset(self::$_bXDebug) ? self::$_bXDebug : extension_loaded('xdebug');
                if (self::$_bXDebug) {
                    new OG_GDPR_AdminPageFramework_Utility;
                    new OG_GDPR_AdminPageFramework_WPUtility;
                }
            }
            static private $_bXDebug;
        }
        new OG_GDPR_AdminPageFramework_Bootstrap(__FILE__);
    endif;
