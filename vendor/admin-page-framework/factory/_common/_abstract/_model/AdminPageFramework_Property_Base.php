...
abstract class OG_GDPR_AdminPageFramework_Property_Base extends OG_GDPR_AdminPageFramework_FrameworkUtility {
    ...
    private function ___setProperties($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'og-gdpr' : $sTextDomain;
    ...
    private function ___setGlobals() {
        if (!isset($GLOBALS['aOG_GDPR_AdminPageFramework'])) {
            $GLOBALS['aOG_GDPR_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => OG_GDPR_AdminPageFramework_Registry::NAME, 'sURI' => OG_GDPR_AdminPageFramework_Registry::URI, 'sScriptName' => OG_GDPR_AdminPageFramework_Registry::NAME, 'sLibraryName' => OG_GDPR_AdminPageFramework_Registry::NAME, 'sLibraryURI' => OG_GDPR_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => OG_GDPR_AdminPageFramework_Registry::getVersion(), 'sDescription' => OG_GDPR_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => OG_GDPR_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => OG_GDPR_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => OG_GDPR_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => OG_GDPR_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new OG_GDPR_AdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
    }
