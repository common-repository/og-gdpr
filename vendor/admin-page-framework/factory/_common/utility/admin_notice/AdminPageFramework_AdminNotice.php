...
class OG_GDPR_AdminPageFramework_AdminNotice extends OG_GDPR_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'og-gdpr-settings-notice-message', 'og-gdpr-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new OG_GDPR_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
