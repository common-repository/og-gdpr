...
abstract class OG_GDPR_AdminPageFramework_Utility_Deprecated {
    static public function minifyCSS($sCSSRules) {
        OG_GDPR_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getCSSMinified()');
        return OG_GDPR_AdminPageFramework_Utility_String::getCSSMinified($sCSSRules);
    }
    static public function sanitizeLength($sLength, $sUnit = 'px') {
        OG_GDPR_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getLengthSanitized()');
        return OG_GDPR_AdminPageFramework_Utility_String::getLengthSanitized($sLength, $sUnit);
    }
    public static function getCorrespondingArrayValue($vSubject, $sKey, $sDefault = '', $bBlankToDefault = false) {
        OG_GDPR_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getElement()');
        if (!isset($vSubject)) {
            return $sDefault;
        }
    ...
    static public function isAssociativeArray(array $aArray) {
        OG_GDPR_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__);
    ...
    static public function getAttributes(array $aAttributes) {
        OG_GDPR_AdminPageFramework_Utility::showDeprecationNotice(__METHOD__, 'OG_GDPR_AdminPageFramework_WPUtility::getAttributes()');
        $_sQuoteCharactor = "'";
        $_aOutput = array();
    ...
    abstract class OG_GDPR_AdminPageFramework_Utility_VariableType extends OG_GDPR_AdminPageFramework_Utility_Deprecated {
    ...
    abstract class OG_GDPR_AdminPageFramework_Utility_String extends OG_GDPR_AdminPageFramework_Utility_VariableType {
    ...
    abstract class OG_GDPR_AdminPageFramework_Utility_Array extends OG_GDPR_AdminPageFramework_Utility_String {
    ...
    abstract class OG_GDPR_AdminPageFramework_Utility_ArrayGetter extends OG_GDPR_AdminPageFramework_Utility_Array {
    ...
    abstract class OG_GDPR_AdminPageFramework_Utility_ArraySetter extends OG_GDPR_AdminPageFramework_Utility_ArrayGetter {
    ...
    abstract class OG_GDPR_AdminPageFramework_Utility_Path extends OG_GDPR_AdminPageFramework_Utility_ArraySetter {
    ...
    abstract class OG_GDPR_AdminPageFramework_Utility_URL extends OG_GDPR_AdminPageFramework_Utility_Path {
    ...
    abstract class OG_GDPR_AdminPageFramework_Utility_File extends OG_GDPR_AdminPageFramework_Utility_URL {
    ...
    abstract class OG_GDPR_AdminPageFramework_Utility_SystemInformation extends OG_GDPR_AdminPageFramework_Utility_File {
    ...
    abstract class OG_GDPR_AdminPageFramework_Utility_HTMLAttribute extends OG_GDPR_AdminPageFramework_Utility_SystemInformation {
    ...
    class OG_GDPR_AdminPageFramework_Utility extends OG_GDPR_AdminPageFramework_Utility_HTMLAttribute {
