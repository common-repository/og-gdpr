...
class OG_GDPR_AdminPageFramework_Form_View___DebugInfo extends OG_GDPR_AdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='og-gdpr-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
