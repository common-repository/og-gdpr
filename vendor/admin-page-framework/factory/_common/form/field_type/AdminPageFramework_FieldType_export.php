...
class OG_GDPR_AdminPageFramework_FieldType_submit extends OG_GDPR_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".og-gdpr-field input[type='submit'] {margin-bottom: 0.5em;}.og-gdpr-field-submit .submit-confirm-container {display: inline-block;margin-left: 1em;vertical-align: middle;}.og-gdpr-field-submit .field-error.submit-confirmation-warning {float: none;}";
    }
    protected function getScripts() {
        return <<<JAVASCRIPTS
jQuery( document ).ready( function(){
    jQuery( '.og-gdpr-field-submit .submit-confirm-container input[type=checkbox]' ).each( function( index, value ){
        jQuery( this ).closest( '.og-gdpr-field-submit' ).find( 'input[type=submit]' ).click( function( event ){
            var _fieldSubmit = jQuery( this ).closest( '.og-gdpr-field-submit' );  
            _fieldSubmit.find( '.submit-confirmation-warning' ).remove(); // previous error message
            var _confirmCheckbox = jQuery( this ).closest( '.og-gdpr-field-submit' ).find( '.submit-confirm-container input[type=checkbox]' );
...
JAVASCRIPTS;
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'og-gdpr-input-label-container' . ' og-gdpr-input-button-container' . ' og-gdpr-input-container',);
    }
    ...
    class OG_GDPR_AdminPageFramework_FieldType_export extends OG_GDPR_AdminPageFramework_FieldType_submit {
