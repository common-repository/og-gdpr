...
abstract class OG_GDPR_AdminPageFramework_Form_View___Generate_Field_Base extends OG_GDPR_AdminPageFramework_Form_View___Generate_Section_Base {
    ...
    class OG_GDPR_AdminPageFramework_Form_View___Generate_FieldName extends OG_GDPR_AdminPageFramework_Form_View___Generate_Field_Base {
        public function get() {
    ...
    class OG_GDPR_AdminPageFramework_Form_View___Generate_FlatFieldName extends OG_GDPR_AdminPageFramework_Form_View___Generate_FieldName {
        public function get() {
    ...
    class OG_GDPR_AdminPageFramework_Form_View___Generate_FieldAddress extends OG_GDPR_AdminPageFramework_Form_View___Generate_FlatFieldName {
        public function get() {
