...
class OG_GDPR_AdminPageFramework_Form___SubmitNotice extends OG_GDPR_AdminPageFramework_FrameworkUtility {
    ...
    public function render() {
        new OG_GDPR_AdminPageFramework_AdminNotice('');
    ...
    private function _printNotices($aNotices) {
        ...
        foreach (array_filter(( array )$aNotices, 'is_array') as $_aNotice) {
            ...
            new OG_GDPR_AdminPageFramework_AdminNotice($this->getElement($_aNotice, 'sMessage'), $this->getElement($_aNotice, 'aAttributes'));
        }
    }
    }
