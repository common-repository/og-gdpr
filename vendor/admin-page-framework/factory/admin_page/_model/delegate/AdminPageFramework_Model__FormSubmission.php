...
abstract class OG_GDPR_AdminPageFramework_Model__FormSubmission_Base extends OG_GDPR_AdminPageFramework_Form_Utility {
    ...
    class OG_GDPR_AdminPageFramework_Model__FormSubmission extends OG_GDPR_AdminPageFramework_Model__FormSubmission_Base {
        public $oFactory;
        public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
            $this->oFactory = $oFactory;
            $this->_handleFormData();
            new OG_GDPR_AdminPageFramework_Model__FormRedirectHandler($oFactory);
        }
        public function _handleFormData() {
            ...
            new OG_GDPR_AdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
