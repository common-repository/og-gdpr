...
abstract class OG_GDPR_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('OG_GDPR_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new OG_GDPR_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
