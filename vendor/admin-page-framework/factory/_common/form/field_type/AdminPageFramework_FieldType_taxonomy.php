...
class OG_GDPR_AdminPageFramework_FieldType_taxonomy extends OG_GDPR_AdminPageFramework_FieldType_checkbox {
    ...
    protected function setUp() {
        new OG_GDPR_AdminPageFramework_Form_View___Script_CheckboxSelector;
    }
    protected function getScripts() {
        $_aJSArray = json_encode($this->aFieldTypeSlugs);
        return parent::getScripts() . <<<JAVASCRIPTS
/* For tabs */
var enableOG_GDPR_AdminPageFrameworkTabbedBox = function( nodeTabBoxContainer ) {
...
jQuery( document ).ready( function() {
    ...
    enableOG_GDPR_AdminPageFrameworkTabbedBox( jQuery( '.tab-box-container' ) );
    ...
    jQuery().registerOG_GDPR_AdminPageFrameworkCallbacks( {
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            // Initialize
            enableOG_GDPR_AdminPageFrameworkTabbedBox( oCloned.find( '.tab-box-container' ) );
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".og-gdpr-field .taxonomy-checklist li { margin: 8px 0 8px 20px; }.og-gdpr-field div.taxonomy-checklist {padding: 8px 0 8px 10px;margin-bottom: 20px;}.og-gdpr-field .taxonomy-checklist ul {list-style-type: none;margin: 0;}.og-gdpr-field .taxonomy-checklist ul ul {margin-left: 1em;}.og-gdpr-field .taxonomy-checklist-label {white-space: nowrap; }.og-gdpr-field .tab-box-container.categorydiv {max-height: none;}.og-gdpr-field .tab-box-tab-text {display: inline-block;font-size: 13px;font-size: smaller;padding: 2px;}.og-gdpr-field .tab-box-tabs {line-height: 12px;margin-bottom: 0;}.og-gdpr-field .tab-box-tabs .tab-box-tab.active {display: inline;border-color: #dfdfdf #dfdfdf #fff;margin-bottom: 0px;padding-bottom: 4px;background-color: #fff;}.og-gdpr-field .tab-box-container { position: relative; width: 100%; clear: both;margin-bottom: 1em;}.og-gdpr-field .tab-box-tabs li a { color: #333; text-decoration: none; }.og-gdpr-field .tab-box-contents-container {padding: 0 0 0 1.8em;padding: 0.55em 0.5em 0.55em 1.8em;border: 1px solid #dfdfdf; background-color: #fff;}.og-gdpr-field .tab-box-contents { overflow: hidden; overflow-x: hidden; position: relative; top: -1px; height: 300px;}.og-gdpr-field .tab-box-content { display: none; overflow: auto; display: block; position: relative; overflow-x: hidden;}.og-gdpr-field .tab-box-content .taxonomychecklist {margin-right: 3.2em;}.og-gdpr-field .tab-box-content:target, .og-gdpr-field .tab-box-content:target, .og-gdpr-field .tab-box-content:target { display: block; }.og-gdpr-field .tab-box-content .select_all_button_container, .og-gdpr-field .tab-box-content .select_none_button_container{display: inline-block;margin-top: 0.8em;}.og-gdpr-field .taxonomychecklist .children {margin-top: 6px;margin-left: 1em;}";
    }
