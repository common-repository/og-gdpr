...
class OG_GDPR_AdminPageFramework_Model__FormSubmission__Validator_Base extends OG_GDPR_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    ...
    class OG_GDPR_AdminPageFramework_Model__FormSubmission__Validator extends OG_GDPR_AdminPageFramework_Model__FormSubmission__Validator_Base {
        public $oFactory;
        ...
        public function _replyToValidateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
            ...
            $_aClassNames = array('OG_GDPR_AdminPageFramework_Model__FormSubmission__Validator__Link', 'OG_GDPR_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'OG_GDPR_AdminPageFramework_Model__FormSubmission__Validator__Import', 'OG_GDPR_AdminPageFramework_Model__FormSubmission__Validator__Export', 'OG_GDPR_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'OG_GDPR_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'OG_GDPR_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'OG_GDPR_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
            ...
            try {
                ...
                $_oFormSubmissionFilter = new OG_GDPR_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
